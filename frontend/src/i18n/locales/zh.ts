export default {
  ...
  dashboard: {
    ...
    openOnlineExperience: '打开在线体验',
    useChatAndImages: '直接体验对话、文生图和图生图'
  },

  onlineExperience: {
    badge: '在线体验',
    title: '在线体验',
    description: '直接使用当前账号余额与分组能力，无需额外创建密钥。聊天、文生图和图生图都走 Sub2API 当前的 OpenAI 网关实现。',
    balanceLabel: '共享余额',
    currentGroup: '当前分组',
    noGroup: '未选择分组',
    chatModels: '文字模型',
    imageModels: '图片模型',
    groupLabel: '体验分组',
    groupHint: '请选择一个管理员已分配给你的 OpenAI 分组。',
    loadingModels: '正在刷新模型列表',
    selectGroup: '选择分组',
    emptyTitle: '当前账号没有可用的 OpenAI 分组',
    emptyDescription: '在线体验会复用你已有的分组权限和额度。如果这里为空，通常表示管理员还没有给你分配可用的 OpenAI 分组或订阅。',
    emptyAction: '查看我的订阅',
    tabs: {
      chat: '对话',
      text2img: '文生图',
    ...
    selectModel: '选择模型',
    noModelSelected: '暂无可用模型',
    systemPrompt: '系统提示词',
    systemPromptPlaceholder: '例如：你是一个简洁、严谨、会直接给出结果的中文助手。',
    chatPrompt: '输入内容',
    chatPlaceholder: '输入你的问题、任务或要处理的文本内容。',
    send: '发送',
    stop: '停止生成',
    retry: '重新生成',
    ...
    imagePrompt: '图片提示词',
    imagePromptPlaceholder: '例如：夜色中的未来城市，镜头低机位，潮湿柏油路反射霓虹，电影级光影，细节丰富。',
    editPrompt: '编辑提示词',
    editPromptPlaceholder: '描述你希望如何修改上传图片，例如：保留主体，把背景替换成雨夜城市街景，整体更有电影感。',
    generateImage: '生成图片',
    generateEditedImage: '生成编辑结果',
    generatingAction: '生成中...',
    uploadTitle: '上传参考图片',
    uploadHint: '支持最多 4 张图片，单张不超过 10MB。图片会直接提交到当前分组下的图生图接口。',
    uploadImage: '上传图片',
    conversationPanel: '对话输出',
    imagePanel: '图片结果',
    generating: '正在生成',
    userRole: '用户',
    assistantRole: '助手',
    emptyAssistantReply: '模型没有返回可展示的内容。',
    imageResult: '结果 #{index}',
    imageEmptyTitle: '还没有图片结果',
    imageEmptyDescription: '输入清晰的画面描述后即可在这里查看生成结果。',
    editEmptyDescription: '上传参考图并给出修改要求后，编辑结果会显示在这里。',
    noImageResult: '模型已完成请求，但没有返回可展示的图片。',
    invalidImageFile: '请选择有效的图片文件。',
    imageTooLarge: '图片过大，单张图片不能超过 10MB。',
    tooManyUploads: '最多只能上传 4 张图片。',
    ...
    suggestionPrompts: {
      debug: '帮我定位下面这段报错的根因，并给出最小修复方案。',
      summary: '把下面的技术方案压缩成 5 条可以执行的结论。',
      write: '帮我写一段上线公告，语气简洁，面向普通用户。',
      translate: '把下面这段中文翻译成自然的英文，并保留技术术语。'
    }
  },
  ...
  admin: {
    ...
    accounts: {
      ...
      bulkActions: {
        ...
        testConnectionSuccess: '已成功测试 {count} 个账号',
  ...
  version: {
    ...
    updateComplete: '更新完成',
    deployStarted: '部署已启动',
    deployStartedHint: 'GitHub Actions 正在拉取你的自定义镜像并重建服务',
    viewDeployRun: '查看部署任务',
    customReleasePending: '等待自定义版本',
    customReleasePendingHint: '上游已有更新，但 {repo} 尚未发布合并后的版本',
    viewSyncPR: '查看同步 PR',
    deployNotConfigured: '部署未配置',
    deployNotConfiguredHint: '请配置 UPDATE_DEPLOY_GITHUB_TOKEN 后再使用在线部署',
    updateFailed: '更新失败',
