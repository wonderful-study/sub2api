export default {
  ...
  dashboard: {
    ...
    openOnlineExperience: 'Open Online Experience',
    useChatAndImages: 'Try chat, text-to-image, and image editing directly'
  },

  onlineExperience: {
    badge: 'Online Experience',
    title: 'Online Experience',
    description: 'Use your current balance and assigned groups directly from the user panel. Chat, text-to-image, and image editing all reuse the existing Sub2API OpenAI gateway.',
    balanceLabel: 'Shared Balance',
    currentGroup: 'Current Group',
    noGroup: 'No Group Selected',
    chatModels: 'Chat Models',
    imageModels: 'Image Models',
    groupLabel: 'Experience Group',
    groupHint: 'Choose one of your assigned OpenAI groups.',
    loadingModels: 'Refreshing model list',
    selectGroup: 'Select Group',
    emptyTitle: 'No OpenAI groups are available for this account',
    emptyDescription: 'The online experience page reuses your existing group permissions and balance. If nothing appears here, an administrator still needs to assign an OpenAI group or subscription to your account.',
    emptyAction: 'View My Subscriptions',
    tabs: {
      chat: 'Chat',
    ...
    noModelSelected: 'No model available',
    systemPrompt: 'System Prompt',
    systemPromptPlaceholder: 'Example: You are a concise and rigorous assistant that answers in clear English.',
    chatPrompt: 'Prompt',
    chatPlaceholder: 'Ask a question, draft something, or paste text to process.',
    send: 'Send',
    stop: 'Stop',
    retry: 'Retry',
    ...
    imagePromptPlaceholder: 'Example: A futuristic city at night, low camera angle, rain-soaked streets reflecting neon, cinematic lighting, high detail.',
    editPrompt: 'Edit Prompt',
    editPromptPlaceholder: 'Describe how the uploaded image should change, for example: keep the subject, replace the background with a rainy night city street, cinematic mood.',
    generateImage: 'Generate Image',
    generateEditedImage: 'Generate Edited Image',
    generatingAction: 'Generating...',
    uploadTitle: 'Upload Reference Images',
    uploadHint: 'Upload up to 4 images. Each file must be 10MB or smaller. Files go straight to the current group image-edit endpoint.',
    uploadImage: 'Upload Image',
    conversationPanel: 'Conversation Output',
    imagePanel: 'Image Results',
    generating: 'Generating',
    userRole: 'User',
    assistantRole: 'Assistant',
    emptyAssistantReply: 'The model returned no visible content.',
    imageResult: 'Result #{index}',
    imageEmptyTitle: 'No images yet',
    imageEmptyDescription: 'Generated images will appear here after you submit a prompt.',
    editEmptyDescription: 'Upload one or more images and describe the change to preview edited results here.',
    noImageResult: 'The request completed but no image payload was returned.',
    invalidImageFile: 'Please choose a valid image file.',
    imageTooLarge: 'Image is too large. Each file must be 10MB or smaller.',
    tooManyUploads: 'You can upload up to 4 images.',
    ...
    suggestionPrompts: {
      debug: 'Help me identify the root cause of the following error and propose the smallest safe fix.',
      summary: 'Compress the following technical plan into 5 clear and actionable conclusions.',
      write: 'Write a short release announcement for end users in a calm product tone.',
      translate: 'Translate the following Chinese text into natural English while keeping the technical terms intact.'
    }
  },
  ...
  version: {
    ...
    deployNow: 'Deploy Update',
    updating: 'Updating...',
    updateComplete: 'Update Complete',
    deployStarted: 'Deployment Started',
    deployStartedHint: 'GitHub Actions is pulling your custom image and recreating the service',
    viewDeployRun: 'View Deployment',
    customReleasePending: 'Custom Release Pending',
    customReleasePendingHint: 'Upstream has an update, but {repo} has not published the merged release yet',
    viewSyncPR: 'View Sync PRs',
    deployNotConfigured: 'Deployment Not Configured',
    deployNotConfiguredHint: 'Set UPDATE_DEPLOY_GITHUB_TOKEN before using online deployment',
